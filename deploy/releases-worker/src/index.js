  ...
  <div class="wrap">
    ...
    <div class="grid">
      <div class="card">
        ...
        <p>Run the installer and follow the setup prompts. Windows may show a SmartScreen warning while code-signing validation is completed.</p>
        <a class="btn" href="/desktop/${VERSION}/CroweLogic-${VERSION}-x64-setup.exe">Download for Windows</a>
      </div>
      <div class="card">
        <h2>macOS</h2>
