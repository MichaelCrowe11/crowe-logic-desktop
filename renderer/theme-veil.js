/* The theme, before anything is drawn. renderer.js applies it too, but that
   ...
   cover, moved rather than removed. Loaded first in <body> via <script src>,
   after the body exists but before visible content, because the strict script
   policy has no 'unsafe-inline' to offer an inline copy. Idempotent:
   applyTheme() toggles the same class and stays the source of truth. */
try {
