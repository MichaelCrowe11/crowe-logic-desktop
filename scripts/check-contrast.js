...
const TEXT = [
  ...
  ["--bubble-me-ink", "--bubble-me", "your text in your bubble"],
  ["--bubble-them-ink", "--bubble-them", "a worker's text in its bubble"],
  ["--muted", "--bubble-them", "a working note in a worker's bubble"],
