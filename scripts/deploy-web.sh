...
FILES=("$TMPD/app.html" renderer/farm-compliance.css renderer/farm-recovery.js renderer/farm-compliance.js renderer/mycology-transfer.js renderer/mycology-transfer.css renderer/council.css renderer/council.js renderer/council-ui.js renderer/rooms-local.js renderer/adopted-styles.js renderer/web-bridge.js renderer/web-ui.js renderer/mobile-gate.js renderer/theme-bootstrap.js renderer/mark-geometry.js renderer/mark.js renderer/rooms-web.js renderer/activity.js renderer/first-run.js renderer/messages.js renderer/marks.js renderer/renderer.js renderer/styles.css mobile/src/mobile.css mobile/src/mobile-ui.js)
